...
**Embedded & IoT:**  
ESP32, microcontroller programming, hardware integration

**Databases:**  
PostgreSQL, relational database design (basic–intermediate)

---

## 🚀 Featured Projects

### 🔧 ESP32 Flashcard Device
Battery-powered embedded system with a web-based management interface.  
Focus: IoT communication, low-power design, and embedded C++ development.
...
### 🛡️ HoneyManager (Group Project)
Cybersecurity honeypot network system with logging and incident response features.  
Focus: network security concepts and monitoring systems.
